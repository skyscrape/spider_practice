...
//         _ts = 1758182327000;
//         m = _0x474032(_ts)
//         _0x4e96b4['_$pr'].push(m)
//     }
//
// }
// function getRM4hZBv0dDon443M(){
//     _0x4e96b4['_$pr'] = get_pr();
//     _$yw = _0x2d5f5b()["toString"]();
//     _0x4e96b4['_$is'] = _$yw;
//     _0x4e96b4['_$qF'] = CryptoJS['enc']['Utf8']["parse"](btoa(_0x4e96b4['_$is'])['slice'](0x0, 0x10));
//     _$Ww = CryptoJS['enc']['utf-8']['parse'](_0x4e96b4['_$pr']['toString']());
//     _0x29dd83 = CryptoJS['AES'](_$Ww, _0x4e96b4['_$qF'], {
...
function getParamers() {
    ...
    for (i = 1; i < 5; i++) {
        ...
        pr.push(_0x474032(1758182327000))
    }
